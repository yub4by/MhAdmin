...
Mock.mock('/captcha', 'get', () => {
    Result.data = {
        ...
        myCaptchaImg: Random.dataImage( "120x40", "11111" ) //生成验证码为11111的base64图片编码
    }
    return Result
})
...
Mock.mock('/sys/userInfo', 'get', () => {
    Result.data = {
        id: '2',
        username: 'test2',
        avatar: 'https://cdn.jsdelivr.net/gh/yub4by/picx-image-hosting@master/20211102/6.7ks10ihl7g80.jpg'
    }
    return Result
})
