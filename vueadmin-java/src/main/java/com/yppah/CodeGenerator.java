...
/**
 * 代码生成原理：
 *      1、获取项目数据库所对应表和字段的信息（从数据库自带的information_schema表中获取信息）
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 默认所有的实体类都继承BaseEntity，控制器都继承BaseController，所以在代码生成之前，最好先编写这两个基类
        // 公共父类
